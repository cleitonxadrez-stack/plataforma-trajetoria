...
export default async function DocumentoDetalhe({ params }: Props) {
  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-12">
      ...
      <h1 className="serif text-3xl text-[#0B2341] mb-1" style={{ wordBreak: "break-word" }}>
      ...
      <section style={{ marginTop: 24 }}>
        <h2 className="serif text-xl text-[#0B2341] mb-2">Histórico (audit)</h2>
          ...
          {view.audit.map((ev, i) => (
            <li key={i}
              ...
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: 13 }}>
                <span style={{ fontFamily: "monospace", color: "#1F5EFF" }}>{ev.action}</span>
