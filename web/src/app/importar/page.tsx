  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-10">
      ...
      <header className="mb-6">
        <h1 className="serif text-3xl text-[#0B2341]">Importar currículo Lattes</h1>
      ...
      <section className="card mb-6">
        <h2 className="serif text-lg text-[#0B2341] mb-2">Como obter seu XML</h2>
        <ol className="text-sm text-stone-700 space-y-2 list-decimal list-inside">
          <li>
            Abra seu currículo em <a className="underline text-[#0B2341]" href="https://www.lattes.cnpq.br" target="_blank" rel="noopener noreferrer">lattes.cnpq.br</a> e
            clique no botão <strong>Exportar</strong> (ícone no topo).
          </li>
          <li>
            Na janela <em>“Exportar currículo para RTF ou XML”</em>, escolha
            <strong className="text-[#0B2341]"> XML</strong> (⚠️ <strong>não</strong> RTF) e confirme.
          </li>
      ...
      <section className="card mb-6">
        <h2 className="serif text-lg text-[#0B2341] mb-2">Upload do XML</h2>
        <LattesImporter endpoint="/api/lattes/import" />
      </section>

      {existingList.length > 0 && (
        <section className="card">
          <h2 className="serif text-lg text-[#0B2341] mb-2">
          ...
          <p className="mt-4">
            <Link href="/trajetoria" className="text-sm text-[#0B2341] underline">
