...
export default async function PendenciasPage() {
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-12">
      ...
      <h1 className="serif text-4xl text-[#0B2341] mb-1">Pendências por instituição</h1>
          ...
          return (
            <section key={g.institutionId} style={{ marginBottom: 24 }}>
              <header style={{ display: "flex", alignItems: "baseline", gap: 12, marginBottom: 6 }}>
                <h2 className="serif text-2xl text-[#0B2341]">{g.institutionName}</h2>
...
function EmptyPendencias() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-16">
      <p className="text-xs uppercase tracking-[.14em] text-stone-500 mb-2">Recuperação assistida</p>
      <h1 className="serif text-4xl text-[#0B2341] mb-3">Nenhuma pendência por enquanto</h1>
